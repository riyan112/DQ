...
$this->title = $model->jenisasalsekolah_id;
$this->params['breadcrumbs'][] = ['label' => 'Jenisasalsekolah', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="jenisasalsekolah-view">

    <div class="row">
        <div class="col-sm-9">
            <h2><?= 'Jenisasalsekolah'.' '. Html::encode($this->title) ?></h2>
        </div>
        <div class="col-sm-3" style="margin-top: 15px">
            
            <?= Html::a('Update', ['update', 'id' => $model->jenisasalsekolah_id], ['class' => 'btn btn-primary']) ?>
            <?= Html::a('Delete', ['delete', 'id' => $model->jenisasalsekolah_id], [
