...
$this->title = $model->kelasparalel_id;
$this->params['breadcrumbs'][] = ['label' => 'Kelasparalel', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="kelasparalel-view">

    <div class="row">
        <div class="col-sm-9">
            <h2><?= 'Kelasparalel'.' '. Html::encode($this->title) ?></h2>
        </div>
        <div class="col-sm-3" style="margin-top: 15px">
            
            <?= Html::a('Update', ['update', 'id' => $model->kelasparalel_id], ['class' => 'btn btn-primary']) ?>
            <?= Html::a('Delete', ['delete', 'id' => $model->kelasparalel_id], [
