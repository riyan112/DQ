...
/* @var $searchModel app\models\PeriodetracerSearch */
...
?>
<div class="periodetracer-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a('Create Periodetracer', ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Jenistracer', 'id' => 'grid-periodetracer-search-jenistracer_id']
            ],
