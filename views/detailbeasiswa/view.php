...
$this->title = $model->detailbeasiswa_id;
$this->params['breadcrumbs'][] = ['label' => 'Detailbeasiswa', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="detailbeasiswa-view">

    <div class="row">
        <div class="col-sm-9">
            <h2><?= 'Detailbeasiswa'.' '. Html::encode($this->title) ?></h2>
        </div>
        <div class="col-sm-3" style="margin-top: 15px">
            
            <?= Html::a('Update', ['update', 'id' => $model->detailbeasiswa_id], ['class' => 'btn btn-primary']) ?>
            <?= Html::a('Delete', ['delete', 'id' => $model->detailbeasiswa_id], [
...
<?php 
    $gridColumn = [
        ...
        [
            'attribute' => 'sumberbeasiswa.sumberbeasiswa_id',
...
?>
    ...
    <div class="row">
        <h4>Jenisbeasiswa<?= ' '. Html::encode($this->title) ?></h4>
    </div>
    <?php 
    $gridColumnJenisbeasiswa = [
        'namabeasiswa',
    ];
    echo DetailView::widget([
        'model' => $model->jenisbeasiswa,
        'attributes' => $gridColumnJenisbeasiswa    ]);
    ?>
    <div class="row">
        <h4>Sumberbeasiswa<?= ' '. Html::encode($this->title) ?></h4>
    </div>
    <?php 
    $gridColumnSumberbeasiswa = [
        'namasumberbeasiswa',
    ];
    echo DetailView::widget([
        'model' => $model->sumberbeasiswa,
        'attributes' => $gridColumnSumberbeasiswa    ]);
    ?>
