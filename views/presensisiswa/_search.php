...
/* @var $model app\models\PresensisiswaSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-presensisiswa-search">
    ...
    <?php /* echo $form->field($model, 'izinsiswa_id')->widget(\kartik\widgets\Select2::classname(), [
