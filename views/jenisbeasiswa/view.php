...
$this->title = $model->jenisbeasiswa_id;
$this->params['breadcrumbs'][] = ['label' => 'Jenisbeasiswa', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="jenisbeasiswa-view">

    <div class="row">
        <div class="col-sm-9">
            <h2><?= 'Jenisbeasiswa'.' '. Html::encode($this->title) ?></h2>
        </div>
        <div class="col-sm-3" style="margin-top: 15px">
            
            <?= Html::a('Update', ['update', 'id' => $model->jenisbeasiswa_id], ['class' => 'btn btn-primary']) ?>
            <?= Html::a('Delete', ['delete', 'id' => $model->jenisbeasiswa_id], [
