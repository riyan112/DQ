...
$this->title = $model->alattransportasi_id;
$this->params['breadcrumbs'][] = ['label' => 'Alattransportasi', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="alattransportasi-view">

    <div class="row">
        <div class="col-sm-9">
            <h2><?= 'Alattransportasi'.' '. Html::encode($this->title) ?></h2>
        </div>
        <div class="col-sm-3" style="margin-top: 15px">
            
            <?= Html::a('Update', ['update', 'id' => $model->alattransportasi_id], ['class' => 'btn btn-primary']) ?>
            <?= Html::a('Delete', ['delete', 'id' => $model->alattransportasi_id], [
