...
<div class="pelanggaran-view">
    ...
    <div class="row">
        <div class="col-sm-9">
            <h2><?= 'Pelanggaran'.' '. Html::encode($this->title) ?></h2>
        </div>
...
?>
    ...
    ?>
    <div class="row">
        <h4>Jenispelanggaran<?= ' '. Html::encode($this->title) ?></h4>
    </div>
    <?php 
    $gridColumnJenispelanggaran = [
        'namapelanggran',
    ];
    echo DetailView::widget([
        'model' => $model->jenispelanggaran,
        'attributes' => $gridColumnJenispelanggaran    ]);
    ?>
    <div class="row">
        <h4>Jeniskonseling<?= ' '. Html::encode($this->title) ?></h4>
    </div>
    <?php 
    $gridColumnJeniskonseling = [
        'namakonseling',
    ];
    echo DetailView::widget([
        'model' => $model->jeniskonseling,
        'attributes' => $gridColumnJeniskonseling    ]);
    ?>
</div>
