...
$this->title = $model->penghasilanortu_id;
$this->params['breadcrumbs'][] = ['label' => 'Penghasilanortu', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="penghasilanortu-view">

    <div class="row">
        <div class="col-sm-9">
            <h2><?= 'Penghasilanortu'.' '. Html::encode($this->title) ?></h2>
        </div>
        <div class="col-sm-3" style="margin-top: 15px">
            
            <?= Html::a('Update', ['update', 'id' => $model->penghasilanortu_id], ['class' => 'btn btn-primary']) ?>
            <?= Html::a('Delete', ['delete', 'id' => $model->penghasilanortu_id], [
