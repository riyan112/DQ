...
$this->title = $model->jaraklokasisiswa_id;
$this->params['breadcrumbs'][] = ['label' => 'Jaraklokasisiswa', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="jaraklokasisiswa-view">

    <div class="row">
        <div class="col-sm-9">
            <h2><?= 'Jaraklokasisiswa'.' '. Html::encode($this->title) ?></h2>
        </div>
        <div class="col-sm-3" style="margin-top: 15px">
            
            <?= Html::a('Update', ['update', 'id' => $model->jaraklokasisiswa_id], ['class' => 'btn btn-primary']) ?>
            <?= Html::a('Delete', ['delete', 'id' => $model->jaraklokasisiswa_id], [
