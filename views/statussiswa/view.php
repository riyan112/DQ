...
$this->title = $model->statussiswa_id;
$this->params['breadcrumbs'][] = ['label' => 'Statussiswa', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="statussiswa-view">

    <div class="row">
        <div class="col-sm-9">
            <h2><?= 'Statussiswa'.' '. Html::encode($this->title) ?></h2>
        </div>
        <div class="col-sm-3" style="margin-top: 15px">
            
            <?= Html::a('Update', ['update', 'id' => $model->statussiswa_id], ['class' => 'btn btn-primary']) ?>
            <?= Html::a('Delete', ['delete', 'id' => $model->statussiswa_id], [
