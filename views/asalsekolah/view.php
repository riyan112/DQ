...
$this->title = $model->asalsekolah_id;
$this->params['breadcrumbs'][] = ['label' => 'Asalsekolah', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="asalsekolah-view">

    <div class="row">
        <div class="col-sm-9">
            <h2><?= 'Asalsekolah'.' '. Html::encode($this->title) ?></h2>
        </div>
        <div class="col-sm-3" style="margin-top: 15px">
            
            <?= Html::a('Update', ['update', 'id' => $model->asalsekolah_id], ['class' => 'btn btn-primary']) ?>
            <?= Html::a('Delete', ['delete', 'id' => $model->asalsekolah_id], [
