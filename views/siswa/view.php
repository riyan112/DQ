...
<div class="siswa-view">
    ...
    <div class="row">
        ...
        <?php 
        $foto = $model->fotosiswa;
        $fotosiswa = Html::img(Yii::$app->request->baseURL.'/img_fotosiswa/'.$model->fotosiswa,['width' => '300px']);
        $contohfoto = Html::img(Yii::$app->request->baseURL.'/img/contohfoto.jpg',['width' => '300px']);
        if ($foto == !null){
        echo $fotosiswa;
        }else{
            echo $contohfoto;
            ...
            //die();
        ?>
            <h2><?php //'Siswa'.' '. Html::encode($this->title) ?></h2>
        </div>
