...
$this->title = $model->citacita_id;
$this->params['breadcrumbs'][] = ['label' => 'Citacita', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="citacita-view">

    <div class="row">
        <div class="col-sm-9">
            <h2><?= 'Citacita'.' '. Html::encode($this->title) ?></h2>
        </div>
        <div class="col-sm-3" style="margin-top: 15px">
            
            <?= Html::a('Update', ['update', 'id' => $model->citacita_id], ['class' => 'btn btn-primary']) ?>
            <?= Html::a('Delete', ['delete', 'id' => $model->citacita_id], [
